...
suite("ChecksFetcher tree naming", () => {
  ...
  test("single direct run with children gets tree emoji", () => {
    const runs = [
      ...
      makeRun({
        checkName: "Test",
        externalId: '{"parent":"build#1","run":"test#2"}',
      }),
    ];
    (fetcher as any).computeTreeNames(runs);
  ...
  test("parallel children at same depth get the same number", () => {
    const runs = [
      ...
      makeRun({
        checkName: "Child1",
        externalId: '{"parent":"parent#1","run":"child1#2"}',
      }),
      makeRun({
        checkName: "Child2",
        externalId: '{"parent":"parent#1","run":"child2#3"}',
      }),
      makeRun({
        checkName: "Child3",
        externalId: '{"parent":"parent#1","run":"child3#4"}',
      }),
    ];
    (fetcher as any).computeTreeNames(runs);
  ...
  test("malformed JSON externalId keeps original name when no dependencies", () => {
    const runs = [
      makeRun({ checkName: "Weird", externalId: "not-really-json}" }),
    ];
    (fetcher as any).computeTreeNames(runs);
  ...
  test("broken parent chain keeps original name when no real dependencies", () => {
    const runs = [
      makeRun({
        checkName: "Child",
        externalId: '{"parent":"ghost#1","run":"child#2"}',
      }),
    ];
    (fetcher as any).computeTreeNames(runs);
  ...
  test("runs without externalId keep original names while others get prefixed and sorted", () => {
    const runs = [
      ...
      makeRun({
        checkName: "Child",
        externalId: '{"parent":"parent#1","run":"child#2"}',
      }),
    ];
    (fetcher as any).computeTreeNames(runs);
  ...
  test("sort is stable within same depth", () => {
    const runs = [
      ...
      makeRun({
        checkName: "ChildB",
        externalId: '{"parent":"parent#1","run":"childB#3"}',
      }),
      makeRun({
        checkName: "ChildA",
        externalId: '{"parent":"parent#1","run":"childA#2"}',
      }),
    ];
    (fetcher as any).computeTreeNames(runs);
  ...
  test("two separate trees are grouped by tree then by depth", () => {
    const runs = [
      ...
      makeRun({
        checkName: "Downstream-A2",
        externalId: '{"parent":"pipeA#1","run":"dsA2#3"}',
      }),
      makeRun({
        checkName: "Downstream-A1",
        externalId: '{"parent":"pipeA#1","run":"dsA1#2"}',
      }),
      makeRun({ checkName: "Pipeline-B", externalId: "pipeB#1" }),
      makeRun({
        checkName: "Downstream-B1",
        externalId: '{"parent":"pipeB#1","run":"dsB1#2"}',
      }),
    ];
    (fetcher as any).computeTreeNames(runs);
  ...
  test("three separate trees preserve their groups", () => {
    const runs = [
      ...
      makeRun({
        checkName: "Tree1-Leaf",
        externalId: '{"parent":"t1#1","run":"t1l#2"}',
      }),
      makeRun({
        checkName: "Tree3-Leaf",
        externalId: '{"parent":"t3#1","run":"t3l#2"}',
      }),
      makeRun({
        checkName: "Tree2-Leaf",
        externalId: '{"parent":"t2#1","run":"t2l#2"}',
      }),
    ];
    (fetcher as any).computeTreeNames(runs);
