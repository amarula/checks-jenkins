...
- **Rerun Triggers**: Directly trigger a Jenkins job rerun from the Gerrit interface. Rerun buttons are automatically disabled while any pipeline job of the displayed change is running — preventing accidental double-triggers.
...
- Clone from gerrithub.io and take the clone instructions from: https://gerrithub.io/admin/repos/amarula/checks-jenkins,general
